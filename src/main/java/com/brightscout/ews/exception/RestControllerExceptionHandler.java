...
import com.brightscout.ews.payload.ExceptionResponse;

@ControllerAdvice
public class RestControllerExceptionHandler {

	@ExceptionHandler(EwsApiException.class)
	@ResponseBody
	public ResponseEntity<ApiResponse> resolveException(EwsApiException exception) {
